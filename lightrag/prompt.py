...
- relationship_keywords: one or more high-level key words that summarize the overarching nature of the relationship, focusing on concepts or themes rather than specific details.use these relationship types firstly [{relation_types}] if you find something more than those values no matter and use them.
