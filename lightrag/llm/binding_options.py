...
class BindingOptions:
    ...
    def args_env_name_type_value(cls):
        ...
        for subclass in subclasses:
            ...
            class_vars = {
                key: value
                for key, value in vars(subclass).items()
...
# Options for Ollama binding are extracted from _types.py of the Ollama Python API.
@dataclass
class OllamaOptions(BindingOptions):
    """Options for Ollama bindings."""

    # mandatory name of binding
    _binding_name: ClassVar[str] = "ollama"
...
# Additional binding options for other LLM providers can be added here
# following the same pattern as OllamaOptions above
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "test":
        ...
        args = parser.parse_args(["--ollama_num_ctx", "512"])
        print(args)
        ollama_options = OllamaOptions.options_dict(args)
        print(ollama_options)
        print(OllamaOptions(num_ctx=4096).asdict())
