...
def display_splash_screen(args: argparse.Namespace) -> None:
    ...
    ASCIIColors.white("    ├─ Ingestion Model: ", end="")
    ASCIIColors.yellow(f"{args.ingestion_llm_model}")
    ASCIIColors.white("    ├─ Query Model: ", end="")
    ASCIIColors.yellow(f"{args.query_llm_model}")
