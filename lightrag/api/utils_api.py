...
def display_splash_screen(args: argparse.Namespace) -> None:
    ...
    ASCIIColors.yellow(f"{repr(args.embedding_document_prefix) if args.embedding_document_prefix else 'Not Set'}")
    ASCIIColors.white("    └─ Query Prefix: ", end="")
    ASCIIColors.yellow(f"{repr(args.embedding_query_prefix) if args.embedding_query_prefix else 'Not Set'}")
