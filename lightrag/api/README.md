...
- **PostgreSQL stack:** LightRAG now standardizes on PostgreSQL; workspace prefixes are applied consistently across KV, vector, doc-status, and graph tables (AGE/pgvector).
