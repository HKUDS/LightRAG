...
class DoclingProcessingResult:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.processing_time_seconds: float = self.metadata.get("processing_time_seconds", 0.0)
...
class DoclingClient:
    ...
    async def process_document(
        ...
        **config_kwargs
        ...
        try:
            ...
            raise DoclingProcessingError(f"Unexpected error processing {file_path.name}: {e}")
    ...
    async def process_batch(
        ...
        **config_kwargs
        ...
        try:
            logger.info("Processing document batch via Docling service",
            ...
            if response.status_code == 200:
                ...
                results = [DoclingProcessingResult(result) for result in batch_data["results"]]
    ...
    async def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"cache_enabled": False, "error": f"Status {response.status_code}"}
