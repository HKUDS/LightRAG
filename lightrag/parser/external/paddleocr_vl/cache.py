...
DEFAULT_PADDLEOCR_VL_API_MODE = "local"
...
class PaddleOCRVLParserOptions:
    ...
    def from_env(
        ...
        *,
        ...
        return cls(
            ...
            # The following options are all in `optionalPayload`.
    ...
    def request_payload(self) -> dict[str, Any]:
        values: tuple[tuple[str, Any], ...] = (
            ...
            ("layoutThreshold", self.layout_threshold),
            ("layoutNms", self.layout_nms),
            ("layoutUnclipRatio", self.layout_unclip_ratio),
            ("layoutMergeBboxesMode", self.layout_merge_bboxes_mode),
