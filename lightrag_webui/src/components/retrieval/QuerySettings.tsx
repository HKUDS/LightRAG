          ...
          <div className="absolute inset-0 flex flex-col gap-2 overflow-auto px-2 pr-2">
            ...
            <div className="flex items-center gap-1">
              <Input
                ...
                onChange={(e) => {
                  ...
                  handleChange('top_k', value === '' ? '' : Number.parseInt(value, 10) || 0)
                }}
                onBlur={(e) => {
                  const value = e.target.value
            ...
            <div className="flex items-center gap-1">
              <Select
                ...
                onValueChange={(v) =>
                  handleChange('citation_mode', v as 'none' | 'inline' | 'footnotes')
                }
              >
                <SelectTrigger
              ...
              <ResetButton
                onClick={() => handleReset('citation_mode')}
            ...
            {querySettings.citation_mode && querySettings.citation_mode !== 'none' && (
              <>
                ...
                <div className="flex items-center gap-1">
                  ...
                  />
                  <ResetButton
                    onClick={() => handleReset('citation_threshold')}
