...
const sections: SectionItem[] = [
  ...
  { id: 'evidence', label: 'Evidence Review', group: 'Review', icon: FileSearchIcon },
  { id: 'quality', label: 'Quality Report', group: 'Review', icon: ShieldCheckIcon },
  { id: 'approval', label: 'Approval Queue', group: 'Review', icon: ClipboardCheckIcon },
