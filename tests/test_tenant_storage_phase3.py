...
class TestTenantContextUnit:
    ...
    def test_tenant_context_creation(self):
        ...
        context = TenantContext(
            tenant_id="tenant_1", kb_id="kb_1", user_id="user_1", role="admin"
        )
    ...
    def test_tenant_context_different_roles(self):
        ...
        for role in roles:
            context = TenantContext(
                tenant_id="tenant_1", kb_id="kb_1", user_id="user_1", role=role
            )
...
class TestTenantModel:
    ...
    def test_tenant_creation_basic(self):
        ...
        tenant = Tenant(tenant_id="test_tenant", tenant_name="Test Tenant")
    ...
    def test_tenant_creation_with_config(self):
        ...
        tenant = Tenant(
            tenant_id="test_tenant", tenant_name="Test Tenant", config=config
        )
    ...
    def test_tenant_inactive_status(self):
        ...
        tenant = Tenant(
            tenant_id="test_tenant", tenant_name="Inactive Tenant", is_active=False
        )
    ...
    def test_tenant_with_metadata(self):
        ...
        tenant = Tenant(tenant_id="test_tenant", tenant_name="Test", metadata=metadata)
...
class TestMultiTenantStructure:
    ...
    def test_tenant_context_scoping(self):
        ...
        context1 = TenantContext(
            tenant_id="t1", kb_id="kb1", user_id="user1", role="admin"
        )
        context2 = TenantContext(
            tenant_id="t2", kb_id="kb1", user_id="user1", role="admin"
        )
    ...
    def test_composite_workspace_naming_convention(self):
        ...
        context_t1_kb1 = TenantContext(
            tenant_id="tenant_1", kb_id="kb_1", user_id="user1", role="admin"
        )
        context_t1_kb2 = TenantContext(
            tenant_id="tenant_1", kb_id="kb_2", user_id="user1", role="admin"
        )
