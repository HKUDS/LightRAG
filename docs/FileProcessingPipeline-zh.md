...
| `mineru` | 外部 MinerU 内容提取引擎 | `pdf` `docx` `ppt` `pptx` `xlsx` `png` `jpg` `jpeg` `jp2` `webp` `gif` `bmp`（可扩展，见 `MINERU_ADDITIONAL_SUFFIXES`） |
