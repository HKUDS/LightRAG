...
| Numerical prizes in B2 | The configured reranker scores all entity/relation descriptions. B1 and B2 consume the actual non-negative scores, with strict index/score validation. |
