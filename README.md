...
| **addon_params** | `dict` | Additional parameters, e.g., `{"language": "Simplified Chinese", "entity_types": ["organization", "person", "location", "event"], 'relation_types': ['LOCATED_AT','HAVE_DOMINATE']}`: sets example limit, entiy/relation extraction output language | language: English` |
