...
class LightRAGDirectClient:
    ...
    async def insert_file(self, file_path: str, **options) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MCPError("UNSUPPORTED_FORMAT", f"Cannot decode file as text: {file_path}")
    ...
    async def get_document(self, document_id: str) -> Dict[str, Any]:
        ...
        raise MCPError("NOT_IMPLEMENTED", "Document retrieval not available in direct mode")
    
    async def delete_documents(self, document_ids: List[str]) -> Dict[str, Any]:
        """Delete documents (not implemented in direct mode)."""
        raise MCPError("NOT_IMPLEMENTED", "Document deletion not available in direct mode")
    ...
    async def get_entity_relationships(self, entity_id: str, **params) -> Dict[str, Any]:
        ...
        raise MCPError("NOT_IMPLEMENTED", "Entity relationships not available in direct mode")
